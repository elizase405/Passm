  ...
  return (
    <div className='flex justify-center items-center w-full h-full'>
        <div className='mx-auto w-[90%] flex justify-center items-center relative w-3/4 h-3/4'>
          {/* border design */}
          <AuthBorder />
          <form onSubmit={handleSubmit(onSubmit)} action="" className="absolute w-full h-full">
            <div className="w-full h-full flex flex-col justify-center items-center">
              ...
              <div className="relative w-4/6 md:w-3/7 lg:w-1/3 flex flex-col items-center">
                <input type="text" name="username" placeholder="Username" {...register("username", { required: "Username is required" })} className="w-full bg-blue-300/10 px-10 py-2 rounded-md outline-none focus:border-blue-300 focus:border-1 mb-6" />
              ...
              <p>Don't have an account? <a href="/register" className="text-blue-300 hover:underline">Register</a></p>
            </div>
          </form>
        </div>
    </div>
